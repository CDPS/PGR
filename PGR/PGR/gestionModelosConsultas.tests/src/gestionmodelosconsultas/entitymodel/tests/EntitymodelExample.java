...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>entitymodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EntitymodelExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.entitymodel"));
				Entity root = EntitymodelFactory.eINSTANCE.createEntity();
