...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>cotracir</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CotracirExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(CotracirPackage.eNS_URI, 
			 CotracirPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.cotracir"));
				Planilla root = CotracirFactory.eINSTANCE.createPlanilla();
