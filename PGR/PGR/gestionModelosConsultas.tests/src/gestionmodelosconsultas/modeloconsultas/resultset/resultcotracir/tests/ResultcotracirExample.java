...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>resultcotracir</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultcotracirExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ResultcotracirPackage.eNS_URI, 
			 ResultcotracirPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.resultcotracir"));
				Transaccion root = ResultcotracirFactory.eINSTANCE.createTransaccion();
