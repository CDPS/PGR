...
public interface ExcelGenerator extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='\r\n\r\n\t\t\r\n\t\tString [] list = new String [ comboNames.size()];\r\n\t\tfor(int i=0;i<comboNames.size();i++){\r\n\t\t\tlist[i] = (String) comboNames.get(i);\r\n\t\t}\r\n\t\t\r\n\t\torg.apache.poi.xssf.usermodel.XSSFDataValidationHelper helper = new org.apache.poi.xssf.usermodel.XSSFDataValidationHelper((XSSFSheet) sheet);\r\n\t\torg.apache.poi.xssf.usermodel.XSSFDataValidationConstraint constraint = (org.apache.poi.xssf.usermodel.XSSFDataValidationConstraint) helper\r\n\t\t\t\t.createExplicitListConstraint(list);\r\n\t\torg.apache.poi.ss.util.CellRangeAddressList regions = new org.apache.poi.ss.util.CellRangeAddressList(row, row, col, col);\r\n\t\torg.apache.poi.xssf.usermodel.XSSFDataValidation dataValidation = (org.apache.poi.xssf.usermodel.XSSFDataValidation) helper.createValidation(constraint, regions);\r\n\t\tsheet.addValidationData(dataValidation);\r\n\t'"
	 * @generated
	 */
