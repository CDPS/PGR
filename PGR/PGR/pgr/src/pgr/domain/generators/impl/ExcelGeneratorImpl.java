...
public class ExcelGeneratorImpl extends MinimalEObjectImpl.Container implements ExcelGenerator {
	...
	public String getAtributtes(final ResultElement element) {
		...
		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Consolidado) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Consolidado consolidado = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Consolidado) element;

			if(consolidado.getID()!=null)
				answer+=consolidado.getID().intValue();
			
			if(consolidado.getRUTA_DESPACHO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getRUTA_DESPACHO();
			}
			
			if(consolidado.getHORA_DESPACHO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getHORA_DESPACHO();
			}
			
			if(consolidado.getREGISTRO_CONSOLIDADO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getREGISTRO_CONSOLIDADO();
			}
			
			if(consolidado.getTOTAL_RECAUDO_BRUTO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getTOTAL_RECAUDO_BRUTO().intValue();
			}
			
			if(consolidado.getTOTAL_RECAUDO_DESPACHO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getTOTAL_RECAUDO_DESPACHO();
			}
			
			if(consolidado.getESTADO_CONSOLIDADO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getESTADO_CONSOLIDADO();
			}
			
			if(consolidado.getESTADO_IMPRESION()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=consolidado.getESTADO_IMPRESION();
			}
		}
		
		
		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Propietario) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Propietario propietario = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Propietario) element;

			if(propietario.getID()!=null)
				answer+=propietario.getID().intValue();
			
			if(propietario.getNOMBRE()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=propietario.getNOMBRE();
			}
			
			if(propietario.getCEDULA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=propietario.getCEDULA();
			}
		}
		
		
		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Detallado) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Detallado detallado = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Detallado) element;

			if(detallado.getID()!=null)
				answer+=detallado.getID().intValue();
			
			if(detallado.getNOMBRE()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=detallado.getNOMBRE();
			}
			
			if(detallado.getREGISTRO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=detallado.getREGISTRO().intValue();
			}
			
			if(detallado.getTOTAL_RECAUDO_TARIFA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=detallado.getTOTAL_RECAUDO_TARIFA().intValue();
			}
			
			if(detallado.getREGISTRO_RECAUDO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=detallado.getREGISTRO_RECAUDO().intValue();
			}
			
			if(detallado.getCOSTO_TARIFA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=detallado.getCOSTO_TARIFA().intValue();
			}
		}
		
		

		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Planilla) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Planilla planilla = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Planilla) element;

			if(planilla.getID()!=null)
				answer+=planilla.getID().intValue();
			
			if(planilla.getNUMERO_MOVIL()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getNUMERO_MOVIL();
			}
			
			if(planilla.getFECHA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getFECHA();
			}
			
			if(planilla.getCEDULA_CONDUCTOR()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getCEDULA_CONDUCTOR();
			}
			
			if(planilla.getCONDUCTOR()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getCONDUCTOR();
			}
			
			if(planilla.getTOTAL()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getTOTAL().intValue();
			}
			
			if(planilla.getTOTAL_RECAUDO_BRUTO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getTOTAL_RECAUDO_BRUTO().intValue();
			}
			
			if(planilla.getTOTAL_RECAUDO_NETO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getTOTAL_RECAUDO_NETO().intValue();
			}
			
			if(planilla.getTOTAL_DEPOSITO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getTOTAL_DEPOSITO().intValue();
			}
			
			if(planilla.getTOTAL_GASTOS()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getTOTAL_GASTOS().intValue();
			}
			
			if(planilla.getLIQUIDADO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getLIQUIDADO().booleanValue();
			}
			
			if(planilla.getUSUARIO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getUSUARIO();
			}
			
			if(planilla.getNOMBRE_PERSONA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getNOMBRE_PERSONA();
			}
			if(planilla.getAPELLIDO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getAPELLIDO();
			}
			
			if(planilla.getCEDULA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getCEDULA();
			}
			if(planilla.getHORA_MODIFICACION()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=planilla.getHORA_MODIFICACION();
			}
		}
		
		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Trama) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Trama trama = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Trama) element;

			if(trama.getID()!=null)
				answer+=trama.getID().intValue();
			
			if(trama.getCADENA_TRAMA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=trama.getCADENA_TRAMA();
			}
		}
		
		if (element instanceof gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Transaccion) {

			gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Transaccion transaccion = (gestionmodelosconsultas.modeloconsultas.resultset.resultcotracir.Transaccion) element;

			if(transaccion.getID()!=null)
				answer+=transaccion.getID().intValue();
			
			if(transaccion.getHORA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getHORA().intValue();
			}
			if(transaccion.getTIPO()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getTIPO();
			}
			
			if(transaccion.getDESCRIPCION()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getDESCRIPCION();
			}
			if(transaccion.getESTADO_TRANSACCION()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getESTADO_TRANSACCION();
			}
			
			if(transaccion.getCATEGORIA()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getCATEGORIA();
			}
			if(transaccion.getVALOR()!=null){
				if (answer.length() > 0)
					answer += ",";
				answer+=transaccion.getVALOR();
			}
		}
		return answer;
	}
