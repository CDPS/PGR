...
public class GeneratorsPackageImpl extends EPackageImpl implements GeneratorsPackage {
	 ...
	 * @generated
	 */
	public EAttribute getViewModelGenerator_QueryElements() {
	...
	public EReference getViewModelGenerator_TheDomain() {
		return (EReference)viewModelGeneratorEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getViewModelGenerator__ExploreRelations() {
	...
	public void createPackageContents() {
		...
		createEAttribute(viewModelGeneratorEClass, VIEW_MODEL_GENERATOR__QUERY_ELEMENTS);
		...
		createEOperation(viewModelGeneratorEClass, VIEW_MODEL_GENERATOR___EXPLORE_RELATIONS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getViewModelGenerator_QueryElements(), theDatatypesjavautilPackage.getArrayList(), "queryElements", null, 0, 1, ViewModelGenerator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getViewModelGenerator__ExploreRelations(), null, "exploreRelations", 0, 1, IS_UNIQUE, IS_ORDERED);
