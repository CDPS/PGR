 ...
 * @generated
 */
public class GestionModelosConsultasModelingAssistantProviderOfConsolidadoEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ConsolidadoEditPart) sourceEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSource(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ConsolidadoEditPart source) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ConsolidadoEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.ConsolidadoEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(
				gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasElementTypes.Relacion_4001);
		return types;
