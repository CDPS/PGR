 ...
 * @generated
 */
public class GestionModelosConsultasModelingAssistantProviderOfTramaEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart) sourceEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSource(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart source) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart) sourceEditPart, targetEditPart);
	}
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart) sourceEditPart,
				relationshipType);
	}
	...
	*/
	public List<IElementType> doGetTypesForTarget(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart source, IElementType relationshipType) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget(
				(gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(
				gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasElementTypes.Relacion_4001);
		return types;
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart) targetEditPart,
				relationshipType);
	}
	...
	*/
	public List<IElementType> doGetTypesForSource(
			gestionmodelosconsultas.diagram_PROYECCION.edit.parts.TramaEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasElementTypes.Relacion_4001) {
			types.add(
					gestionmodelosconsultas.diagram_PROYECCION.providers.GestionModelosConsultasElementTypes.Consolidado_2001);
