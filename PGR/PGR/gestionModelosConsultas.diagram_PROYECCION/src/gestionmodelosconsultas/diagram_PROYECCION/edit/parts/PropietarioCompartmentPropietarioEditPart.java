 ...
 * @generated
 */
public class PropietarioCompartmentPropietarioEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public PropietarioCompartmentPropietarioEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.PropietarioCompartmentPropietarioEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.PropietarioCompartmentPropietarioItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.PropietarioCompartmentPropietarioCanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		...
		Propietario propietario = CotracirFactory.eINSTANCE.createPropietario();
		modelPackage.inizializarEEnum(propietario);
