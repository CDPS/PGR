 ...
 * @generated
 */
public class PlanillaCompartmentPlanillaEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public PlanillaCompartmentPlanillaEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.PlanillaCompartmentPlanillaEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.PlanillaCompartmentPlanillaItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.PlanillaCompartmentPlanillaCanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		...
		Planilla planilla = CotracirFactory.eINSTANCE.createPlanilla();
		modelPackage.inizializarEEnum(planilla);
