 ...
 * @generated
 */
public class TransaccionCompartmentTransaccionEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public TransaccionCompartmentTransaccionEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return gestionmodelosconsultas.diagram_PROYECCION.part.Messages.TransaccionCompartmentTransaccionEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.TransaccionCompartmentTransaccionItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new gestionmodelosconsultas.diagram_PROYECCION.edit.policies.TransaccionCompartmentTransaccionCanonicalEditPolicy());
	}
