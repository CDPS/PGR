 ...
 * @generated
 */
public class GestionModelosConsultasDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(
						new gestionmodelosconsultas.diagram_PROYECCION.navigator.GestionModelosConsultasDomainNavigatorItem(
