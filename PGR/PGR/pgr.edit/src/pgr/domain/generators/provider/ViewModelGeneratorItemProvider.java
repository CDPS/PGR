...
public class ViewModelGeneratorItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addQueryElementsPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Query Elements feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addQueryElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewModelGenerator_queryElements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewModelGenerator_queryElements_feature", "_UI_ViewModelGenerator_type"),
				 GeneratorsPackage.Literals.VIEW_MODEL_GENERATOR__QUERY_ELEMENTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
