		...
		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createTransaccion()));

		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createTrama()));

		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createConsolidado()));

		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createPropietario()));

		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createPlanilla()));

		newChildDescriptors.add
			(createChildParameter
				(ResultsetPackage.Literals.RESULTADO__LIST_RESULT_ELEMENT,
				 ResultcotracirFactory.eINSTANCE.createDetallado()));
	}
