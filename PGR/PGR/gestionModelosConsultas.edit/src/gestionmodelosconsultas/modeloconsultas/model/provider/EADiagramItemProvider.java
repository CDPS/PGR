		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createPlanilla()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createConsolidado()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createTransaccion()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createTrama()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createPropietario()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.EA_DIAGRAM__LIST_ELEMENTO_CONSULTA,
				 CotracirFactory.eINSTANCE.createDetallado()));
	}
